...
<p class="text-center h3 text-primary">Permitir varias ventas al tiempo </p><br>
...
<script>
    function actualizar_comanda() {
        ...
        $.ajax({
            ...
            url: url + "/" + "eventos/actualizar_venta_multiple",
            type: "POST",
            success: function(resultado) {
                ...
                if (resultado.resultado == 1) {
                    ...
                    sweet_alert_start('success', ' Configuración de venta multiple correcta    ');
