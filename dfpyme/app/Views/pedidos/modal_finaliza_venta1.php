 ...
 -->
                ...
                <!--   <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <?php $formas_pago = model('formaPagoModel')->where('aplica', 'true')->orderBy('nombreforma_pago')->findAll(); ?>
                          ...
                          <div class="input-group mb-2">
                            <span class="input-group-text">
                              <img data-bs-toggle="tooltip"
                                ...
                                title="Efectivo"
                                src="../Assets/img/efectivo.png"
                                width="110"
                                height="32"
                                alt="Macondo"
                                class="img-fluid navbar-brand-image cursor-pointer">
                            </span>
                            <input type="text" class="form-control" placeholder="Efectivo" id="efectivo" autocomplete="off">
                          </div>
                        </div>
                      <?php foreach ($formas_pago as $detalle): ?>
                        ...
                        <div class="row mb-2">
                          <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" placeholder="<?php echo $detalle['nombreforma_pago']; ?>"  onkeyup="cambiarValorfrmPago(<?php echo $detalle['idforma_pago'] ?>,this.value)" id="frmPago<?php echo $detalle['idforma_pago'] ?>" autocomplete="off">
                          </div>
                        </div>
                      <?php endforeach; ?>
                    </div>
